...
class GPTEvaluation:
    ...
    def forward(self, data):
        ...
        # answer, GT = data
        # prompts = (
        #     "Rate my answer based on the correct answer out of 100, with higher scores indicating that the answer is closer "
        #     "to the correct answer. Your response should contain only the number, without any additional text, explanation, "
        #     "or punctuation.\n\n"
        #     "Correct Answer: " + GT + "\n\n"
        #     "My Answer: " + answer
        # )
