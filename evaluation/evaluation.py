...
class evaluation_suit():
    ...
    def eval_chatGPT(self, data):
        with ThreadPool(32) as p:  # Change the number based on your CPU cores
...
if __name__ == '__main__':
    ...
    # ego_ref_town12
    parser.add_argument('--root_path1', type=str, default="/data2/DriveLM/CARLA/ego_ref_town12/test_output.json", help='path to prediction file')
    parser.add_argument('--root_path2', type=str, default="/data2/DriveLM/CARLA/test_eval.json", help='path to test file')
