...
def get_args_parser():
    ...
    parser.add_argument('--log_dir', default='./output_traj',
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch % 5 == 0 or (args.output_dir and (epoch + 1 == args.epochs)):
            misc.save_model(
                args=args, model=model, model_without_ddp=model_without_ddp, optimizer=optimizer,
                loss_scaler=loss_scaler, epoch=10)
        print("Saved this epoch checkpoint")
