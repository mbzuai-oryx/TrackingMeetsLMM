...
def train_one_epoch(model: LLaMA_adapter,
    ...
    for data_iter_step, (examples, labels, example_mask, imgs, trajs, egos) in enumerate(metric_logger.log_every(data_loader, print_freq, header)):
        ...
        with torch.cuda.amp.autocast():
             c_loss, m_loss = model(examples, labels, imgs, trajs, egos)
